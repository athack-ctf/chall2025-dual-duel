...
def gen_backdoor():
    ...
    d = 22976206188475568761882341921743615950088573364731002641966091907256902122556
...
def main():
    ...
    print('d = {:x}'.format(d))
    print('dQ = ({:x}, {:x})'.format((d * Q).x, (d * Q).y))
    print('a = {:x}'.format(P256.a))
    print('b = {:x}'.format(P256.b))
    print('p = {:x}'.format(P256.p))
    
    dualec = DualEC(0x8e50e4b19af8f308fcccdcf61fd8e67559bdc53a809c99c8403fb542ec448f64, P, Q)
